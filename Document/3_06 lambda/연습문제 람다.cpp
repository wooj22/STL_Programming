...
int main()
{
	...
	//다음 벡터값 중 3의 배수 만 출력하세요.	// for_each //함수 실행해 주기
	...
	// vec1 에서 값을 두배하여 vec2에 추가하세요.	// transform //특정 결과를 저장
	...
	// 
	// 문자열의 소문자를 대문자로 변경하는 함수를 만들어 보세요. 
	// 문자열과 위 함수를 매개변수로 전달받아,  그 함수로 변경된 값을 리턴하는 함수를 작성하라.
	// 
	// 문자열의 대문자를 소문자로 변경하는 함수를 람다로 작성하여 전달하세요.
}
